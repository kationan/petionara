<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <div class="flex-col md:grid md:gap-2 md:grid-cols-3 grid-rows-3 items-center content-center">
        ...
        <a class="w-full hover:opacity-60 text-white h-32 items-center  cursor-pointer">
            <div class="grid grid-cols-1 gap-4 content-center text-center border-2 h-32 bg-gray-600 hover:opacity-100">
                <h1 class="text-3xl text-center">ADHESION</h1>
            </div>
        </a>
        ...
        <a class="w-full hover:opacity-60 text-white h-32 items-center  cursor-pointer">
            <div class="grid grid-cols-1 gap-4 content-center text-center border-2 h-32 bg-green-500 hover:opacity-100">
                <h1 class="text-3xl text-center">ADHESION</h1>
            </div>
        </a>
        <a href="/" class="w-full hover:opacity-60 text-white h-32  items-cente">
